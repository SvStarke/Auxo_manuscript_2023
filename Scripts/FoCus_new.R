...
homa <- ggplot(linear_mod_HOMA_adjust, aes(AA, factor, fill = Estimate))+
  geom_tile() +
  labs(x = "Auxotrophy", y = "", shape = "")+
  geom_point(aes(shape = sign.label1), size = 1) +
  scale_fill_gradient2(high = "#b2182b", mid = "white", low = "#2166ac") +
...
IL6 <- ggplot(linear_mod_IL6_adjust, aes(AA, factor, fill = Estimate))+
  geom_tile() +
  labs(x = "Auxotrophy", y = "", shape = "")+
  geom_point(aes(shape = sign.label1), size = 1) +
  scale_fill_gradient2(high = "#b2182b", mid = "white", low = "#2166ac") +
...
CRP <- ggplot(linear_mod_CRP_adjust, aes(AA, factor, fill = Estimate))+
  geom_tile() +
  labs(x = "Auxotrophy", y = "", shape = "")+
  geom_point(aes(shape = sign.label1), size = 1) +
  scale_fill_gradient2(high = "#b2182b", mid = "white", low = "#2166ac") +
...
all <- rbind(linear_mod_IBS_adjust, linear_mod_IBD_adjust, linear_mod_diab_adjust, linear_mod_chrond_adjust, linear_mod_HOMA_adjust, linear_mod_IL6_adjust, linear_mod_CRP_adjust)
